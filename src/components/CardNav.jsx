    ...
    <div
      ...
      <nav
        ...
        <div
          ...
          <a href="https://drive.google.com/file/d/1HiQL9ZVU4dnP-608g52VfPfvBW32a5P8/view?usp=sharing" target="_blank" rel="noopener noreferrer">
              <button
              type="button" 
              className="card-nav-cta-button hidden md:inline-flex border-0 rounded-[calc(0.75rem-0.2rem)] px-4 p-1.75 items-center h-full font-medium cursor-pointer transition-colors duration-300"
